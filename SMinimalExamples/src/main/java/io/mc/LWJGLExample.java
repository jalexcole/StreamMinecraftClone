...
public class LWJGLExample {
    // The window handle
	private long window;
    private static final Logger logger = Logger.getLogger(LWJGLExample.class.getName());
	public void run() {
	...
	private void init() {
		...
		glfwWindowHint(GLFW.GLFW_VISIBLE, GLFW.GLFW_FALSE); // the window will stay hidden after creation
