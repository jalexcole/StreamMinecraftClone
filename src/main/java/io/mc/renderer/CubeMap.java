...
//        glDepthMask(GL_TRUE);
//    }
    public static final void render(final Shader shader, final Matrix4f projectionMatrix, final Matrix4f viewMatrix, boolean uploadTexture) {
    ...
    //TODO: FIXME
        if (uploadTexture) {
//            GL20.glActivateTexture(GL13.GL_TEXTURE0);
//            glBindTexture(GL_TEXTURE_CUBE_MAP, graphicsId)
        }
    }
//
...
//    }
    ...
    public static CubeMap generateCubeMap() {
